...
# this is a generic "fetcher".  You need to override this N times for N
# source types. for every source you can fetch/transform a parameter.
# You can use the same fetcher for multiple parameters if your fetching code
# is generic (so you do not have to write two very similar fetchers)


class GenericFetcher(object):
    ...
    # return a "readElement" object (it will make a connect to the source)
    @abstractmethod
