...
#needed to treat the containing folder as a python package
from abstract import AbstractEFModel
from abstract import InputParameter
from test import TestModel, DemoModel
